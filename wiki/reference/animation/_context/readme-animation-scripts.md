...
Original path:  animation/scripts/README.md
Original kind:  readme
Folder context: Per-script role table and rig anatomy for animation/scripts/ (Blender 5.x tooling).
Copied on:      2026-05-21
Status:         unreviewed
Maps to:        reference/animation/index.md
-->

> **Reference material.** Verbatim copy of `animation/scripts/README.md` kept in `_context/`
