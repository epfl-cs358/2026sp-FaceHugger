...
Original path:  doc/animation-pipeline/onboard-clip-player-design.md
...
> **Reference material.** Verbatim copy of `doc/animation-pipeline/onboard-clip-player-design.md` kept in `_context/`
