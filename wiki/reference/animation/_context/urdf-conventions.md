...
Original path:  doc/animation-pipeline/urdf-conventions.md
Original kind:  design
Copied on:      2026-05-21
Status:         unreviewed
Maps to:        reference/animation/urdf-pipeline.md
-->

> **Reference material.** Verbatim copy of `doc/animation-pipeline/urdf-conventions.md` kept in `_context/`
