...
Original path:  code/simulation/docs/API_ANIMATION_SPEC.md
Original kind:  spec
...
> **Reference material.** Verbatim copy of `code/simulation/docs/API_ANIMATION_SPEC.md` kept in `_context/`
