...
Original path:  animation/SERVO_ID_CONVENTION.md
Original kind:  spec
Copied on:      2026-05-21
Status:         unreviewed
Maps to:        reference/firmware/servo-conventions.md
-->

> **Reference material.** Verbatim copy of `animation/SERVO_ID_CONVENTION.md` kept in `_context/`
