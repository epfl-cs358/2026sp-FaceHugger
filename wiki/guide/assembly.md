...
**Estimated time:** 4 to 6 hours for a first build.
...
Secure the servo with **4× M3×12 screws**, one in each corner. Tighten evenly, and do not overtighten, as the printed plastic can crack.
...
Each leg's **hip bracket** clips onto one of the four **white mounts** on the body corners. Slide the hip bracket tabs into the mount slots until they click. No screws are needed for this joint, as it is a friction/clip fit.
