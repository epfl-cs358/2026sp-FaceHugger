# code/simulation/animation_tools/clip_loader.py
...
# animation_tools/clip_loader.py → repo root is 3 levels up
# (animation_tools → simulation → code → repo root).
...
@dataclass
class ClipData:
    """Parsed clip, ready for playback via the SIL bridge.
