# code/simulation/pybullet_sim/interpreter/clip_loader.py
...
# pybullet_sim/interpreter/clip_loader.py → repo root is 4 levels up
# (interpreter → pybullet_sim → simulation → code → repo root).
