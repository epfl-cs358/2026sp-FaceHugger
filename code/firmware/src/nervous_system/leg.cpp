...
void Leg::setServo(uint8_t servoId, double angle) {
    if (servoId == 0) hipServo.setServoAngle(angle);
    else if (servoId == 1) thighServo.setServoAngle(angle);
    else if (servoId == 2) kneeServo.setServoAngle(angle);
}
