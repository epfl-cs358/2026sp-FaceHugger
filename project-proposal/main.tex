...
We model a single leg as a 3-link serial chain rotating in the sagittal (pitch) plane.

\begin{figure}[ht]
  \centering
  \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{./img/robot-leg-figure.png}
  \end{minipage}
  \hfill
  \begin{minipage}{0.48\textwidth}
    \centering
    \includegraphics[width=\linewidth]{./img/robot-leg-figure-bent.png}
  \end{minipage}
  \caption{3-link leg model in extended (left) and bent (right) configurations, illustrating the joint angles and link lengths used in the torque analysis.}
  \label{fig:leg-model}
\end{figure}
...
The knee servo supports link $L_3$ and the tip load $m_{\text{tip}}$.
...
\textbf{Inverse solver to find the weight budget:}
...
\]
For link lengths up to 10\,cm at worst-case joint angles ($\theta = 0^{\circ}$), this yields a minimum supportable body weight of 3--4\,kg across four legs, comfortably above our target chassis mass.
...
Checking the simulation across the full parameter range confirms comfortable margins for any realistic leg configuration given the 15\,kg\,cm rated torque of our servos.
...
\begin{figure}[ht]
  \centering
  \includegraphics[width=0.8\textwidth]{./img/interactive-figure-image.png}
  \caption{Screenshot of the interactive Jupyter notebook widget, which allows exploration of the torque equations across the full range of joint angles and design parameters.}
  \label{fig:interactive-notebook}
\end{figure}
...
\hline
ESP32 Devkit V1 Wifi/Bluetooth Dual core & 1 & \href{https://www.conrad.ch/fr/p/carte-de-developpement-joy-it-sbc-nodemcu-esp32-node-mcu-esp32-modul-1656367.html}{Link to buy} & 8\\
\hline
PCA9685 PWM Multiplexer & 1 & \href{https://www.conrad.ch/de/p/iduino-me234-motortreiber-1-st-passend-fuer-entwicklungskits-arduino-2315243.html}{Link to buy} & 11\\
\hline
...
\hline
IMU MPU6050 Accelerometer + Gyroscope & 1 & \href{https://www.galaxus.ch/fr/s1/product/purecrea-mpu-6050-accelerometre-3-axes-avec-gyroscope-carte-de-developpement-kit-36359715}{Link to buy} & 13 \\
\hline
...
\hline
%300W 20A DC-DC Step-down Module & 2 & \href{https://www.joom.com/en/products/67037cacc862c801406e069c}{Link to buy} & 25 \\
%\hline
...
\hline
Male XT60 connector & 2 & \href{https://www.conrad.ch/fr/p/reely-re-6586515-fiche-male-pour-batterie-xt60-3-5-mm-a-souder-1-pc-s-2195505.html}{Link to buy} & 2 \\
\hline
...
\hline
SBC-OLED01V2 128x64 pixels I2C screen & 1 & \href{https://www.galaxus.ch/fr/s1/product/joy-it-sbc-oled01v2-module-daffichage-24-cm-096-pouce-128-x-64-pixels-carte-de-developpement-kit-49727962}{Link to buy} & 10 \\
\hline
